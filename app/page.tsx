...
export default function Home() {
  ...
  const goBack = useCallback(() => setCurrentPly((p) => Math.max(-1, p - 1)), []);
  ...
  return (
    <div className="max-w-2xl mr-auto ml-auto p-4">
      <h1 className="text-xl font-semibold mb-4">PGN Replay</h1>
      ...
      />
      {fileName && (
        <p className="text-sm text-gray-500 mb-2">Loaded: {fileName}</p>
      )}
